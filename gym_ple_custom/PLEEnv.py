...
# gym_ple by lusob - modified
class PLEEnv(gym.Env):
    metadata = {'render.modes': ['human', 'rgb_array']}

    def __init__(self, game_name='FlappyBird', display_screen=True, rng=22):
        # set headless mode
        ...
        self.game_state = PLE(game, fps=30, display_screen=display_screen, rng=rng)
